...
| C403 | **Entrada** do REG710 | 10 µF, 25 V, X5R, 0603 | 1, **só com a Sharp** | [Passivos](../docs/19-lista-de-compras.md#passivos); [14](../docs/14-hardware-placa-nova.md#componentes-principais) pede 10 µF na entrada **e** na saída, e a entrada tinha sido esquecida |
...
| 4 · Display | 15 | 9 | três peças só existem na montagem com a Sharp |
...
```
57 + 2 + 8 + 15 + 16 + 22 = 120
passivas: 40 + 1 + 5 + 9 + 10 + 14 = 79, ou 79 ÷ 120 = 66 %
```
...
> [!NOTE]
> Esta página já deu 89 e depois 91 posições. As diferenças, em ordem
...
| **Painel JDI LPM027M128B** | 4 | a lista só tem o LPM027M128C, "sem canal autorizado; só em revendedores, sem garantia"; a peça comprável é a Sharp LS027B7DH01A ([Display](../docs/19-lista-de-compras.md#display)). A busca de 2026-09-23 achou o **C** no AliExpress a partir de R$ 324, com anúncios que confundem o B e o C ([15](../docs/15-avaliacao-componentes.md#a-luz-da-tela-procurada-em-2026-09-23)) |
