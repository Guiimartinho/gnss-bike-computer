...
| Carga pelo painel | e-peas AEM10900 (QFN28), indutor de 6,8 µH | o único avaliado com MPPT na faixa das strings de 3 células, cerca de 90 % de rendimento a 1,5–1,7 V e corte térmico sem MCU | nenhum com corte térmico e 80 mA; o BQ25798 pediria strings de 7 células ou mais |
...
| GNSS | u-blox MAX-M10N-10B, em LEAP | 13,5 mW contra 46,8 mW do MAX-F10S: o aparelho gasta cerca de 21 mW contra 58 mW e dura cerca de 320 h contra 115 h, e o painel cobre o consumo num pedal de sol | MAX-F10S no mesmo footprint |
...
| Display | JDI LPM027M128C, com o Sharp LS027B7DH01 previsto no mesmo conector | cor e 30 µW a 1 quadro/s; o Sharp tem estoque e já roda no port | Sharp LS027B7DH01 (monocromático, 5 V) |
...
| IMU e magnetômetro | ST LSM6DSV16X e LIS2MDL | fusão interna, despertar por movimento, sensor hub | ST LIS2DW12 e Memsic MMC5603NJ |
...
| USB-C | receptáculo IPX8 (Amphenol 12402484E512A ou Molex 2036150003) | dispensa a tampa de borracha | GCT USB4105-GF-A com tampa |
| Proteção do USB | TI ESD751 no VBUS, TI TPD4E05U06 no D+, D−, CC1 e CC2 | o TVS do VBUS não conduz até 24 V e preserva os 22 V do nPM1300 | TI TVS2200 no VBUS |
...
|---|---|---|---|---|---|---|
| **e-peas AEM10900** | 0,12 a 2,73 V (circuito aberto até 3,0 V) | 250 mV, 2,47 µW | 85 mA com 6,8 µH; 175,5 mA com 3,3 µH | sim (0 e 45 °C por padrão) | QFN28 de 4 × 4 mm | **escolhido** |
...
| Temperatura | TH no BATT, usando o sensor interno de ±1 °C: os dois NTC da célula já estão ocupados; o CI fica junto do conector da bateria |
...
flowchart LR
    ...
    PROT --> NPM["nPM1300 QFN32<br/>carregador linear de 32 a 800 mA<br/>BUCK1 3,0 V, BUCK2 1,8 V"]
    NPM -->|"VBUSOUT"| DIV["divisor<br/>100 kΩ e 1 MΩ"]
    DIV -->|"DIS_STO_CH"| AEM
    PV["6 módulos de 3 células<br/>em paralelo"] --> AEM["AEM10900 QFN28<br/>MPPT a 80 %, indutor de 6,8 µH"]
...
- BUCK1 em 3,0 V e BUCK2 em 1,8 V pelos resistores de VSET1 e VSET2; indutores de 2,2 µH com DCR abaixo de 400 mΩ, em 0806, como na lista de referência (tabela 40 do datasheet). A lista de referência tem ainda 1,0 µF de 10 V, 10 µF de 25 V, 2,2 µF e 100 nF.
- LDSW1 como chave do microSD (100 mA); LDSW2 livre.
- NTC do pack no pino NTC; botão de ligar no SHPHLD; GPIO3 como interrupção para o MCU.
...
- **Indutor de 6,8 µH:** TDK VLS252012HBX-6R8M-1 (2,5 × 2,0 × 1,2 mm, 1,15 A), o valor que o datasheet recomenda para o melhor rendimento e o único com curvas publicadas. Com o modo de alta potência, que vem ligado, a corrente máxima de entrada é 579 / L = 85 mA, no pico estimado do arranjo. O mesmo footprint aceita 4,7 µH (123 mA) ou 3,3 µH (175,5 mA, com pico de pelo menos 1 A) se a bancada mostrar o painel limitado ao meio-dia.
- CSRC, CINT e CSTO de 22 µF (Murata GRM158R60J226ME01, 0402, 6,3 V, a lista mínima do datasheet). No CSTO, 10 V em 0603 dá mais capacitância efetiva com 4,2 V aplicados; com a bateria num conector, o datasheet pede pelo menos 5 µF efetivos.
- R_MPP[2:0] abertos: 80 %, a razão do silício monocristalino (1,67 V / 2,07 V = 0,81).
- T_MPP[1:0] abertos (padrão); o tempo entre medidas do MPP se ajusta na bancada, pedalando sob árvores.
- STO_CFG[2:0] = H, L, H: 3,90 V de carga e 3,01 V de descarga.
- KEEP_ALIVE no VINT; I2C_ADDR no I2C_VDD (endereço 0x41); I2C_VDD no 3V0; IRQ para o MCU; ST_STO num ponto de teste.
- TH_REF e TH_MON com NTC de 10 kΩ e B3380 (Murata NCP15XH103J03RC) colado na célula e RDIV de 22 kΩ 1 %, os valores dos limites padrão de 0 e 45 °C.
...
Rastreio contínuo a 1 Hz, GPS + Galileo + BeiDou (o padrão de cada módulo), com os números das fichas. Os do M10N vêm da ficha do MAX-M10N-00B (R05): a do 10B não foi obtida, e o SAW na frente do LNA deve custar um pouco de sensibilidade.
...
| Consumo em rastreio | LEAP: 7,5 mA a 1,8 V (13,5 mW); potência plena: 15,2 mA (27,4 mW) | 26 mA a 1,8 V (46,8 mW) | 15,2 mA a 1,8 V (27 mW) | 10 mA a 3,3 V (33 mW); modo ALP: 5,5 mA (18 mW) | 33 mA a 1,8 V (59 mW) |
...
xychart-beta
    ...
    y-axis "mW" 0 --> 60
    bar [13.5, 27.4, 27, 33, 46.8, 59]
```

### Efeito no aparelho

Resto do aparelho no uso típico do [orçamento](13-placa-nova.md#orçamento-de-energia): 5,3 mW (MCU e rádios, display, sensores e microSD, PMIC), reguladores a cerca de 90 % e 90 % dos 7,4 Wh da célula de 2000 mAh utilizáveis.

| GNSS | Aparelho, na bateria | Autonomia sem sol | Pedal de sol com os painéis do desenho (22 a 44 mW) |
|---|---|---|---|
| MAX-M10N-10B em LEAP (13,5 mW) | cerca de 21 mW | cerca de 320 h | o painel cobre o consumo e a bateria carrega enquanto se pedala |
| MAX-M10N-10B em potência plena (27,4 mW) | cerca de 36 mW | cerca de 185 h | devolve de 36 a 73 min por hora |
...
1. **Energia:** com o M10N em LEAP, o aparelho gasta cerca de 21 mW, contra 58 mW com o F10S. A autonomia sem sol sobe de cerca de 115 h para cerca de 320 h, e o painel passa a sustentar o aparelho num pedal de sol. É a diferença entre o painel ser um enfeite e ser uma função.
...
- **Alimentação:** VCC e V_IO em 1,8 V pelo BUCK2 (VIO_SEL em GND). A 3,0 V o M10N em LEAP gasta 16,5 mW, 3 mW a mais, mas dispensaria o tradutor de nível e o BUCK2.
...
- **Ripple:** com 7,5 mA o BUCK2 fica no modo histerético, que a ficha do nPM1300 dá com até 50 mVpp de ripple, no limite do que o GNSS aceita. O filtro LC junto do módulo (ferrite e 10 µF) é obrigatório; a outra saída é forçar o BUCK2 em PWM (5 mVpp), que consome mais.
- **Desligar com o backup ligado:** com V_IO em 1,8 V e V_BCKP alimentado, a ficha pede desligar o V_IO 100 ms antes do VCC ou mandar `UBX-RXM-PMREQ` antes de cortar os dois. Como VCC e V_IO saem do mesmo BUCK2, o firmware manda o `UBX-RXM-PMREQ` antes de desligar o trilho ou de entrar em ship mode.
- **Backup:** V_BCKP de 1,65 a 3,6 V pelo TPS7A02; 34 µA em backup de hardware (ficha do M10N-00B, com V_BCKP em 3,3 V).
...
- **Potência na entrada de RF:** o máximo absoluto do RF_IN é 0 dBm (fichas do M10N-00B e do F10S). Com +8 dBm no rádio de 2,4 GHz, a isolação entre as antenas precisa passar de 8 dB com folga; meça o S21 em 2,44 GHz no protótipo e limite a potência de transmissão do BLE e do ANT+ se precisar.
...
O BM20C tem pinos LGA, não castelados: a montagem é por estêncil e forno, como a do MAX17262. Antes do layout, a ficha do módulo precisa confirmar:

1. **USB:** D+, D− e VBUS expostos. Sem eles, o aparelho perde o CDC e o MSC do legacy.
2. **Cristal de 32,768 kHz:** tolerância de no máximo ±50 ppm, que o ANT exige.
3. **Antena e footprint:** guia de layout (área livre, distância de metal) e o desenho do LGA.
4. **Variante do chip:** o `sdk-ant` e o port compilam para o nRF54LM20A.
...
| Contorno | 61,8 × 40,08 × 1,39 mm (a versão C, com luz, é mais grossa: medir) | 62,8 × 42,82 × 1,64 mm |
...
| Luz | 16 mA na versão C | não tem |
| FPC | 10 vias, passo de 0,5 mm; conector indicado: Hirose FH28-10S-0.5SH(05) | 10 vias, passo de 0,5 mm, **na mesma ordem**; conectores indicados: SMK CFP-4610-0150F ou Molex 51441-1093 (contato por baixo) |
| Compra | risco alto: a JDI não lista mais MIP, a Switch Science encerrou as vendas e a DigiKey marca como obsoletos os módulos da Azumo com esse painel | DigiKey e Adafruit |
| Firmware | o `jdi,lpm013m126` do Zephyr aceita até 255 px por eixo e precisa de mudanças | o port já desenha nele |

A cor e o consumo fazem do JDI a melhor tela, mas não há canal autorizado de compra. Uma placa que só aceita o JDI pode ficar sem tela. A escolha é desenhar para os dois no mesmo conector:

- **Pinagem:** conferida nas duas fichas, a ordem dos 10 pinos é a mesma (SCLK, SI, SCS, EXTCOMIN, DISP, VDDA, VDD, EXTMODE, VSS, VSSA).
- **Alimentação selecionável:** 3,0 V do BUCK1 para o JDI ou 5 V de uma bomba de carga para o Sharp, com resistores de 0 Ω. A V3 já usa o TI REG710 de 5 V para o LS027 ([02](02-hardware.md)); o footprint dele fica na placa e só é montado com o Sharp. O EXTMODE vai ao VDD do display, qualquer que seja a tensão, e a inversão do VCOM vem do PWM no EXTCOMIN; na V3 o EXTMODE fica em GND e o VCOM se inverte pelo SPI ([02](02-hardware.md)), o que o driver precisa acompanhar. **Um JDI com 5 V queima**: a montagem precisa deixar isso impossível de errar (por exemplo, uma única posição de resistor que escolhe a fonte).
- **Conector:** as duas fichas indicam contato por baixo em modelos diferentes; confira na amostra do JDI o lado do contato e escolha um conector que sirva aos dois.
- **Caixa:** a janela e o apoio seguem o contorno maior, o do Sharp.
- **Compra do JDI:** amostras de brokers ou do AliExpress, testadas antes do layout, e um lote que cubra a produção prevista.
...
| IMU | ST LSM6DSV16X (LGA-14 de 2,5 × 3,0 mm) | acelerômetro e giroscópio com fusão interna (vetor de gravidade que resiste à vibração), despertar por movimento no driver `st,lsm6dsv16x` e sensor hub para o magnetômetro | ST LIS2DW12 (só acelerômetro, como o legacy; 0,38 µA no modo de despertar) |
| Magnetômetro | ST LIS2MDL (LGA de 2 × 2 mm) | driver `st,lis2mdl` e leitura pelo sensor hub do IMU | Memsic MMC5603NJ (WLP de 0,8 × 0,8 mm, difícil de montar à mão) |
...
- **O IMU pesa com o M10N.** Com acelerômetro e giroscópio em alto desempenho, o LSM6DSV16X consome 0,65 mA, cerca de 2 mW a 3,0 V: 10 % do aparelho com o M10N em LEAP. O acelerômetro sozinho em baixo consumo gasta de 17 a 20 µA a 60 Hz. O firmware liga o giroscópio só quando precisa (tela de percurso, inclinação sob aceleração).
- **Estoque:** o LSM6DSV16X e o LIS2MDL estavam sem estoque na DigiKey na pesquisa; confira antes de fechar a lista de materiais.
...
|---|---|---|
| Conector | receptáculo USB-C IPX8: Amphenol 12402484E512A (USB 2.0, montagem sobre a placa, SMT, 5 A e 20 V, ativo na DigiKey) ou Molex 2036150003 (16 pinos, IPX8, SMT em ângulo reto, ativo) | na série da Amphenol, silicone líquido colado à carcaça veda o corpo e um anel veda contra a parede da caixa: o aparelho dispensa a tampa de borracha. O GCT USB4105-GF-A da especificação anterior não tem grau de proteção (3,31 mm de altura, 20 mil ciclos) e pediria tampa. Altura e furo na parede saem do desenho de cada fabricante |
| VBUS | TI ESD751 (SOD-523 de 1,6 × 0,8 mm) | TVS feito para o VBUS de USB PD: não conduz até ±24 V, então sobrevive a um carregador defeituoso de 9 a 20 V, que o nPM1300 aguenta (22 V) e isola pela proteção de sobretensão; 1,6 pF. O TVS fica junto do conector e corta o pico rápido de uma descarga; o capacitor de 10 µF e 25 V junto do nPM1300 absorve a carga |
...
- **Dois NTC de 10 kΩ e B3380 no pack**, um para o nPM1300 e outro para o AEM10900, num conector de 4 vias; ou o NTC de 3 fios do pack e um segundo colado na célula. Os limites padrão do AEM10900 (0 e 45 °C) supõem o B3380 com 22 kΩ.
...
| Isolação | Ioff-float | com qualquer VCC abaixo de 100 mV, as saídas ficam em alta impedância: com o BUCK2 desligado, o tradutor não alimenta o GNSS pelos pinos, o que a ficha do módulo proíbe em backup de hardware |
...
Alternativa sem tradutor: o GNSS inteiro em 3,0 V pelo BUCK1 (VIO_SEL aberto). Custa 3 mW com o M10N em LEAP (10 mW com o F10S) e libera o BUCK2; em compensação, a ficha permite desligar VCC e V_IO juntos, sem o `UBX-RXM-PMREQ` antes.
...
| Os três botões | chaves táteis seladas (IP67) ou chaves comuns sob uma membrana de silicone vedada na caixa | a peça sai do projeto mecânico; a pesquisa não confirmou uma família específica |
| LED de carga | LED de 0603 no LED1 do nPM1300, anodo no VSYS | acende carregando sem firmware (o LED1 sai de fábrica como indicador de carga); 5 mA de corrente constante, sem resistor |
| LED RGB | 3 canais PWM do MCU, com transistores nos catodos e o anodo no VSYS | o verde e o azul de InGaN têm pouca folga para o resistor em 3,0 V; o WS2812B da V3 pede 5 V, e o port troca o `neopixel.c` pelos `pwm-leds` |
| Buzzer | piezo Same Sky CPT-1117-83-SMT-TR (11 × 9 mm) | dois PWM em contrafase dobram a excursão sobre o piezo |
| Luz do display | transistor com PWM | 16 mA a 2,67 V na ficha do JDI. Com 3,0 V sobram só 0,33 V para o resistor, e a corrente varia muito com a tensão do LED: meça a amostra e, se precisar, alimente pelo VSYS com resistor ou use uma fonte de corrente |
...
| Painel no modelo da caixa | os 6 módulos na caixa impressa, ao meio-dia e sob árvores | corrente de pico (limite de 85 mA com 6,8 µH); tempo do MPPT pedalando na sombra variável | indutor e T_MPP |
...
| Display | amostras do JDI e um Sharp no mesmo conector | espessura da versão C, lado do contato do FPC, tensão da luz a 16 mA, driver de 8 cores | [Display](#display) |
| Sensores | placas com BMP585 e LSM6DSV16X | BMP585 no driver `bosch,bmp581` (chip ID 0x51); consumo do LSM6DSV16X em baixo consumo | [Sensores](#sensores) |
...
- ST, LSM6DSV16X datasheet: consumo por modo (tabela 4).
