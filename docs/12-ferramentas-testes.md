...
| `test_fit_encode` | `model/fit_encode.c` | 14 | o cabeçalho de 14 bytes e o `.FIT`, as mensagens de definição e de dados, os tipos base, as escalas de altitude, distância e velocidade, os valores "inválidos" do formato, os semicírculos, a data do legacy virando `date_time`, as voltas numeradas, o CRC-16 conferido contra o cálculo direto para 33 tamanhos de arquivo, e um passeio inteiro lido de volta mensagem a mensagem |
