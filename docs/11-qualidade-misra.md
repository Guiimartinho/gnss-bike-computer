...
| Testes de host | 8 conjuntos, 60 casos, com `-Werror` ([12](12-ferramentas-testes.md)) |
...
| sem testes | 60 casos de host cobrindo vetores, zonas, suffer score, NMEA, log, gestão do GPS, desligamento automático e a formatação dos números da interface, e o renderizador das telas no PC |
