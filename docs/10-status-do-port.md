...
- **Compila** no NCS v3.3.0 sem aviso (nRF52840 DK: FLASH 473.952 B, RAM 220.352 B; nRF54LM20 DK: FLASH 498.624 B, RAM 249.760 B) e **passa em 14 conjuntos de testes de host** (133 casos). **Nada foi testado na placa** nem nos DKs.
