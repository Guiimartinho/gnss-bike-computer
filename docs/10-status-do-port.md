...
- **Compila** no NCS v3.3.0 sem aviso (nRF52840 DK: FLASH 473.516 B, RAM 220.352 B; nRF54LM20 DK: FLASH 496.548 B, RAM 249.736 B) e **passa em 13 conjuntos de testes de host** (126 casos). **Nada foi testado na placa** nem nos DKs.
