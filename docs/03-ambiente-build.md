...
| Item | Valor |
|---|---|
| FLASH | 473.436 B (45,15 % de 1 MB) |
| RAM | 220.352 B (84,06 % de 256 KB) |
| Avisos | 0 |
| Erros | 0 |
| Tempo | cerca de 1 min do zero (pelos horários dos logs) |
| nRF54LM20 DK | FLASH 487.172 B (24,52 % de 1.940 KB), RAM 249.456 B (47,67 % de 511 KB), 0 avisos |
| Com `ANT=1` | nRF52840 DK: FLASH 502.028 B, RAM 224.832 B; nRF54LM20 DK: FLASH 517.124 B, RAM 254.048 B; só o aviso do símbolo obsoleto |
