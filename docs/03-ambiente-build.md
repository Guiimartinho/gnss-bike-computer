...
| Item | Valor |
|---|---|
| FLASH | 473.516 B (45,16 % de 1 MB) |
| RAM | 220.352 B (84,06 % de 256 KB) |
| Avisos | 0 |
| Erros | 0 |
| Tempo | cerca de 1 min do zero (pelos horários dos logs) |
| nRF54LM20 DK | FLASH 496.548 B (25,00 % de 1.940 KB), RAM 249.736 B (47,73 % de 511 KB), 0 avisos |
| Com `ANT=1` | nRF52840 DK: FLASH 502.108 B, RAM 224.832 B; nRF54LM20 DK: FLASH 526.500 B, RAM 254.320 B; só o aviso do símbolo obsoleto |
