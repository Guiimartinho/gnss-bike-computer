...
| Testes de host | `bash tools/fw/host_tests.sh` (13 conjuntos, 126 casos) |
...
Referência de 2026-09-19, com a interface, o medidor e o carregador: nRF52840 DK FLASH 473.516 B (45,2 %), RAM 220.352 B (84,1 %); nRF54LM20 DK FLASH 496.548 B, RAM 249.736 B; 0 avisos. Com `ANT=1`: 502.108 B / 224.832 B (nRF52840) e 526.500 B / 254.320 B (nRF54LM20), com um aviso esperado, de símbolo obsoleto.
...
| As 29 telas, uma a uma | [docs/telas/README.md](docs/telas/README.md) |
